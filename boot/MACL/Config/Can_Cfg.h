...
#define CanConf_CanHardwareObject_CCP_REQUEST_Box_Index 0U /* RECEIVE object of Can Controller ID = 0 */
#define CanConf_CanHardwareObject_HS2_REQ_DIAG_ON_CAN_6B6 1U /* RECEIVE object of Can Controller ID = 0 */
#define CanConf_CanHardwareObject_HS2_REQ_DIAG_ON_CAN_BROADCAST 2U /* RECEIVE object of Can Controller ID = 0 */
#define CanConf_CanHardwareObject_HS2_REP_DIAG_ON_CAN_696 3U /* TRANSMIT object of Can Controller ID = 0 */
#define CanConf_CanHardwareObject_CCP_RESPONSE_Box_Index 4U /* TRANSMIT object of Can Controller ID = 0 */
...
*
*/
#define CCP_REQUEST_Box_Index 0U /* RECEIVE object of Can Controller ID = 0 */
#define HS2_REQ_DIAG_ON_CAN_6B6 1U /* RECEIVE object of Can Controller ID = 0 */
#define HS2_REQ_DIAG_ON_CAN_BROADCAST 2U /* RECEIVE object of Can Controller ID = 0 */
#define HS2_REP_DIAG_ON_CAN_696 3U /* TRANSMIT object of Can Controller ID = 0 */
#define CCP_RESPONSE_Box_Index 4U /* TRANSMIT object of Can Controller ID = 0 */
...
*
*/
#define CAN_MAXMB_CONFIGURED 5U
...
#define CAN_B_WAKEUPINT_SUPPORTED  (STD_OFF)
...
*/
    ...
    #endif
#else
    #define CAN_TIMEOUT_DURATION 65U    
...
*/
  ...
  /* @violates @ref Can_Cfg_h_REF_3 Violates MISRA 2004 Required Rule 19.4, source code mentenability. */
  #define CanConfigSet_0 Can_ConfigSet_PC
...
*/
#define CAN_MAX_OBJECT_ID ((uint32)5U)
/*==================================================================================================
*                                      DEFINES AND MACROS
==================================================================================================*/
