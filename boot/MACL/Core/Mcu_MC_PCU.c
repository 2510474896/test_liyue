...
/** @violates @ref Mcu_MC_PCU_c_REF_3 MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked ... */
#define MCU_MC_PCU_AR_RELEASE_MINOR_VERSION_C       0
/** @violates @ref Mcu_MC_PCU_c_REF_3 MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked ... */
#define MCU_MC_PCU_AR_RELEASE_REVISION_VERSION_C    3
...
FUNC( void, MCU_CODE) Mcu_MC_PCU_PowerInit(P2CONST( Mcu_MC_PCU_ConfigType, AUTOMATIC, MCU_APPL_DATA) MC_PCU_pConfigPtr)
{
    ...
    /* Voltage detectors interrupt enable */
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    REG_WRITE_LOCK32( PMC_BASEADDR, PMC_VD_INTR_ENA_ADDR32, MC_PCU_pConfigPtr->u32VoltageDetectorInterruptControl | PMC_VD_INTR_ENA_IE_EN_MASK32);

    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    REG_WRITE_LOCK32( PMC_BASEADDR, PMC_VD_INTR_ENA_ADDR32, MC_PCU_pConfigPtr->u32VoltageDetectorInterruptControl);
    ...
    /* reset event enable */
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    REG_WRITE_LOCK32( PMC_BASEADDR, PMC_REE_0_ADDR32, MC_PCU_pConfigPtr->u32ResetEventEnable);

    /* reset event selection */
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    REG_WRITE_LOCK32( PMC_BASEADDR, PMC_RES_0_ADDR32, MC_PCU_pConfigPtr->u32ResetEventSelection);
...
*
* @isr
* @implements Mcu_PMU_VoltageError_Int_Activity
*/
FUNC( void, MCU_CODE) Mcu_PMU_VoltageError_Int( VAR( void, AUTOMATIC) )
{
    ...
    /* read the isr flags */
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    u32VoltageIsrStatus = REG_READ32(PMC_PMC_STATUS_ADDR32) & PMC_PMC_STATUS_MASK32;
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    u32AfeIsrStatus = REG_READ32(PMC_AFE_INTR_STATUS_ADDR32) & PMC_AFE_INTR_STATUS_MASK32;

    /* clear IRQ flags */
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    REG_WRITE_LOCK32( PMC_BASEADDR, PMC_PMC_STATUS_ADDR32, u32VoltageIsrStatus );
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    REG_WRITE_LOCK32( PMC_BASEADDR, PMC_AFE_INTR_STATUS_ADDR32, u32AfeIsrStatus );

    /* read the enable isr's */
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    u32VoltageIsrEnabled = REG_READ32(PMC_VD_INTR_ENA_ADDR32) & PMC_VD_INTR_ENA_RWBITS_MASK32;
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    u32AfeIsrEnabled = REG_READ32(PMC_AFE_INTR_ENA_ADDR32) & PMC_AFE_INTR_ENA_RWBITS_MASK32;

    /* check if there is an event to report */
    if((uint32)0x00000000U != u32VoltageIsrStatus)
    {
        if(PMC_VD_INTR_ENA_RWBITS_MASK32 == (PMC_VD_INTR_ENA_RWBITS_MASK32 & u32VoltageIsrEnabled))
        {
            u8errorFlag = (uint8)0xFFU;
        }
    }
...
*
* @isr
* @implements Mcu_PMU_TemperatureError_Int_Activity
*/
FUNC( void, MCU_CODE) Mcu_PMU_TemperatureError_Int( VAR( void, AUTOMATIC) )
{
    ...
    if((uint32)0x00000000U != u32PmcIntEnabled)
    {
    ...
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    u32TempSenseStatus = REG_READ32(PMC_TS_ESR_ADDR32) & PMC_TS_ESR_MASK32;
    /* clean the enabled status flags */
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    REG_WRITE_LOCK32(PMC_BASEADDR, PMC_TS_ESR_ADDR32, u32TempSenseStatus);

    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    u32TempSenseEnabled = REG_READ32(PMC_TS_IER_ADDR32) & PMC_TS_IER_RWBITS_USR_MASK32;

    /* report */
    if(PMC_TS_ESR_MASK32 == (PMC_TS_ESR_MASK32 & u32TempSenseStatus))
    {
