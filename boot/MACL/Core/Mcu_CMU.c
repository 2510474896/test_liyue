...
/** @violates @ref Mcu_CMU_c_REF_6 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_CMU_AR_RELEASE_MAJOR_VERSION_C       4
/** @violates @ref Mcu_CMU_c_REF_6 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_CMU_AR_RELEASE_MINOR_VERSION_C       0
/** @violates @ref Mcu_CMU_c_REF_6 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_CMU_AR_RELEASE_REVISION_VERSION_C    3
...
*/
/**
* @violates @ref Mcu_CMU_c_REF_5 This is not a standard library macro
* @violates @ref Mcu_CMU_c_REF_4 Violates MISRA 2004 Required Rule 8.10, this symbol is only used at
* IPV_MCV4 level
*/
CONST(uint32, MCU_CONST) MCU_CMU_BASE_ADDR[] =
{
#ifdef  CMU0_BASEADDR
...
FUNC( void, MCU_CODE) Mcu_CMU_DeInit( VAR( void, AUTOMATIC) )
{
    ...
    for ( u8IndexCmu = 0U; u8IndexCmu < MCU_CMU_UNITS; u8IndexCmu++)
    {
        ...
        /** @violates @ref Mcu_CMU_c_REF_3 Cast from unsigned long to pointer. */
        REG_BIT_CLEAR32( CMU_MDR_X_ADDR32( u8IndexCmu ), MCU_CMU_MDR_MD_RESET_VALUE_U32);
...
*
* @return           void
* @implements Mcu_CMU_ClockFail_Int_Activity
* @violates @ref Mcu_CMU_c_REF_4 Global declaration of function
*/
...
#if (MCU_RGM_CLEAR_CLOCK_IRQ_FLAG == STD_ON)
    Mcu_IPW_RGM_ClearClockFailIrqFlags();
#endif
