...
/** @violates @ref Mcu_MC_ME_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_MC_ME_AR_RELEASE_MINOR_VERSION_C        0
/** @violates @ref Mcu_MC_ME_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_MC_ME_AR_RELEASE_REVISION_VERSION_C     3
...
STATIC FUNC( void, MCU_CODE) Mcu_MC_ME_ConfigureCaddrnReg(P2CONST( Mcu_MC_ME_ModeConfigType, AUTOMATIC, MCU_APPL_DATA) Mcu_pModeConfigPtr);

STATIC FUNC( void, MCU_CODE) Mcu_MC_ME_DeConfigureCaddrnReg(P2CONST( Mcu_MC_ME_ModeConfigType, AUTOMATIC, MCU_APPL_DATA) Mcu_pModeConfigPtr);
...
FUNC( void, MCU_CODE) Mcu_MC_ME_CCTL_Init(P2CONST( Mcu_MC_ME_ConfigType, AUTOMATIC, MCU_APPL_DATA) MC_ME_pConfigPtr)
{
    if ( MC_ME_CCTL_UNUSED_MASK16 != MC_ME_pConfigPtr->u16CCTL0 )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE_LOCK16( MC_ME_BASEADDR, MC_ME_CCTL0_ADDR32, MC_ME_pConfigPtr->u16CCTL0);
    }
    if ( MC_ME_CCTL_UNUSED_MASK16 != MC_ME_pConfigPtr->u16CCTL1 )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE_LOCK16( MC_ME_BASEADDR, MC_ME_CCTL1_ADDR32, MC_ME_pConfigPtr->u16CCTL1);
    }
    if ( MC_ME_CCTL_UNUSED_MASK16 != MC_ME_pConfigPtr->u16CCTL2 )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE_LOCK16( MC_ME_BASEADDR, MC_ME_CCTL2_ADDR32, MC_ME_pConfigPtr->u16CCTL2);
    }
    if ( MC_ME_CCTL_UNUSED_MASK16 != MC_ME_pConfigPtr->u16CCTL3 )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE_LOCK16( MC_ME_BASEADDR, MC_ME_CCTL3_ADDR32, MC_ME_pConfigPtr->u16CCTL3);
    }
    if ( MC_ME_CCTL_UNUSED_MASK16 != MC_ME_pConfigPtr->u16CCTL4 )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE_LOCK16( MC_ME_BASEADDR, MC_ME_CCTL4_ADDR32, MC_ME_pConfigPtr->u16CCTL4);
    }
}
...
*
*/
FUNC( void, MCU_CODE) Mcu_MC_ME_Modes_Periph_Init(P2CONST( Mcu_MC_ME_ConfigType, AUTOMATIC, MCU_APPL_DATA) MC_ME_pConfigPtr)
{
...
FUNC(void, MCU_CODE) Mcu_MC_ME_SystemClkUpdate(VAR(uint32, AUTOMATIC) u32SystemClk)
{
    ...
    switch ( ePowerMode)
    {
        case (MCU_RUN0_MODE):
            ...
            {
                /* Clear the current System Clock selection bits. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_CLEAR_LOCK32(MC_ME_BASEADDR, MC_ME_RUN0_MC_ADDR32, MC_ME_MODE_MC_SYSCLK_MASK32);

                /* Update the new clock settings in current running mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_SET_LOCK32( MC_ME_BASEADDR, MC_ME_RUN0_MC_ADDR32, u32SystemClk);
        ...
        case (MCU_RUN1_MODE):
            ...
            if ( ((uint32)REG_READ32( MC_ME_GS_ADDR32) & (uint32)MC_ME_GS_S_SYSCLK_MASK32) != (uint32)u32SystemClk)
            {
                /* Clear the current System Clock selection bits. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_CLEAR_LOCK32(MC_ME_BASEADDR, MC_ME_RUN1_MC_ADDR32, MC_ME_MODE_MC_SYSCLK_MASK32);

                /* Update the new clock settings in current running mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_SET_LOCK32( MC_ME_BASEADDR, MC_ME_RUN1_MC_ADDR32, u32SystemClk);
        ...
        case (MCU_RUN2_MODE):
            ...
            if ( ((uint32)REG_READ32( MC_ME_GS_ADDR32) & (uint32)MC_ME_GS_S_SYSCLK_MASK32) != (uint32)u32SystemClk)
            {
                /* Clear the current System Clock selection bits. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_CLEAR_LOCK32(MC_ME_BASEADDR, MC_ME_RUN2_MC_ADDR32, MC_ME_MODE_MC_SYSCLK_MASK32);

                /* Update the new clock settings in current running mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_SET_LOCK32( MC_ME_BASEADDR, MC_ME_RUN2_MC_ADDR32, u32SystemClk);
        ...
        case (MCU_RUN3_MODE):
            ...
            if ( ((uint32)REG_READ32(MC_ME_GS_ADDR32) & (uint32)MC_ME_GS_S_SYSCLK_MASK32) != (uint32)u32SystemClk)
            {
                /* Clear the current System Clock selection bits. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_CLEAR_LOCK32(MC_ME_BASEADDR, MC_ME_RUN3_MC_ADDR32, MC_ME_MODE_MC_SYSCLK_MASK32);

                /* Update the new clock settings in current running mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_SET_LOCK32( MC_ME_BASEADDR, MC_ME_RUN3_MC_ADDR32, u32SystemClk);
        ...
        case (MCU_DRUN_MODE):
            ...
            if ( ((uint32)REG_READ32(MC_ME_GS_ADDR32) & (uint32)MC_ME_GS_S_SYSCLK_MASK32) != (uint32)u32SystemClk)
            {
                /* Clear the current System Clock selection bits. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_CLEAR_LOCK32(MC_ME_BASEADDR, MC_ME_DRUN_MC_ADDR32, MC_ME_MODE_MC_SYSCLK_MASK32);

                /* Update the new clock settings in current running mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_SET_LOCK32( MC_ME_BASEADDR, MC_ME_DRUN_MC_ADDR32, u32SystemClk);
        ...
        case (MCU_TEST_MODE):
            ...
            if ( ((uint32)REG_READ32(MC_ME_GS_ADDR32) & (uint32)MC_ME_GS_S_SYSCLK_MASK32) != (uint32)u32SystemClk)
            {
                /* Clear the current System Clock selection bits. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_CLEAR_LOCK32(MC_ME_BASEADDR, MC_ME_TEST_MC_ADDR32, MC_ME_MODE_MC_SYSCLK_MASK32);

                /* Update the new clock settings in current running mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_SET_LOCK32( MC_ME_BASEADDR, MC_ME_TEST_MC_ADDR32, u32SystemClk);
        ...
        case (MCU_HALT0_MODE):
            ...
            if ( ((uint32)REG_READ32( MC_ME_GS_ADDR32) & (uint32)MC_ME_GS_S_SYSCLK_MASK32) != (uint32)u32SystemClk)
            {
                /* Clear the current System Clock selection bits. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_CLEAR_LOCK32(MC_ME_BASEADDR, MC_ME_HALT0_MC_ADDR32, MC_ME_MODE_MC_SYSCLK_MASK32);

                /* Update the new clock settings in current running mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_SET_LOCK32( MC_ME_BASEADDR, MC_ME_HALT0_MC_ADDR32, u32SystemClk);
        ...
        case (MCU_STBY0_MODE):
            ...
            if ( ((uint32)REG_READ32( MC_ME_GS_ADDR32) & (uint32)MC_ME_GS_S_SYSCLK_MASK32) != (uint32)u32SystemClk)
            {
                /* Clear the current System Clock selection bits. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_CLEAR_LOCK32(MC_ME_BASEADDR, MC_ME_STBY0_MC_ADDR32, MC_ME_MODE_MC_SYSCLK_MASK32);

                /* Update the new clock settings in current running mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_BIT_SET_LOCK32( MC_ME_BASEADDR, MC_ME_STBY0_MC_ADDR32, u32SystemClk);
...
*/
/** @violates @ref Mcu_MC_ME_c_REF_5 Global declaration of function. */
FUNC( void, MCU_CODE) Mcu_MC_ME_BlindApplyMode( VAR( Mcu_PowerModeType, AUTOMATIC) ePowerMode)
{
...
*                       - Mcu_MC_ME_Modes_Periph_Init from this file
...
FUNC( void, MCU_CODE) Mcu_MC_ME_ApplyMode( VAR( Mcu_PowerModeType, AUTOMATIC) ePowerMode )
{
    ...
    if (((uint32)MCU_STBY0_MODE == (uint32)(u32ModeConfig >> (uint32)28U)) || ((uint32)MCU_STOP0_MODE == (uint32)(u32ModeConfig >> (uint32)28U)))
    {
        EXECUTE_WAIT();
    }
#endif
...
*
*/
FUNC( void, MCU_CODE) Mcu_MC_ME_ModeConfig(P2CONST( Mcu_MC_ME_ModeConfigType, AUTOMATIC, MCU_APPL_DATA) Mcu_pModeConfigPtr)
{
...
#define MC_ME_ERR_AGREGATOR_0
    ...
    else
    {
        ...
        Mcu_MC_ME_ConfigureCaddrnReg( Mcu_pModeConfigPtr );
#endif /* (MCU_CONFIGURE_CADDRN == STD_ON) */
        ...
        switch (Mcu_pModeConfigPtr->Mcu_ePowerMode)
        {
            ...
            case (MCU_STBY0_MODE):
                ...
                /* Set the new configuration for the mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_WRITE_LOCK32(MC_ME_BASEADDR, MC_ME_STBY0_MC_ADDR32, (uint32)Mcu_pModeConfigPtr->Mcu_u32ModeParams);
            ...
            case (MCU_RUN3_MODE):
                ...
                /* Set the new configuration for the mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_WRITE_LOCK32(MC_ME_BASEADDR, MC_ME_RUN3_MC_ADDR32, (uint32)Mcu_pModeConfigPtr->Mcu_u32ModeParams);
            ...
            case (MCU_RUN2_MODE):
                ...
                /* Set the new configuration for the mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_WRITE_LOCK32(MC_ME_BASEADDR, MC_ME_RUN2_MC_ADDR32, (uint32)Mcu_pModeConfigPtr->Mcu_u32ModeParams);
            ...
            case (MCU_RUN1_MODE):
                ...
                /* Set the new configuration for the mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_WRITE_LOCK32(MC_ME_BASEADDR, MC_ME_RUN1_MC_ADDR32, (uint32)Mcu_pModeConfigPtr->Mcu_u32ModeParams);
            ...
            case (MCU_RUN0_MODE):
                ...
                /* Set the new configuration for the mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_WRITE_LOCK32(MC_ME_BASEADDR, MC_ME_RUN0_MC_ADDR32, (uint32)Mcu_pModeConfigPtr->Mcu_u32ModeParams);
            ...
            case (MCU_DRUN_MODE):
                ...
                /* Set the new configuration for the mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_WRITE_LOCK32(MC_ME_BASEADDR, MC_ME_DRUN_MC_ADDR32, (uint32)Mcu_pModeConfigPtr->Mcu_u32ModeParams);
            ...
            case (MCU_SAFE_MODE):
                ...
                /* Set the new configuration for the mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_WRITE_LOCK32(MC_ME_BASEADDR, MC_ME_SAFE_MC_ADDR32, (uint32)Mcu_pModeConfigPtr->Mcu_u32ModeParams);
            ...
            case (MCU_TEST_MODE):
                ...
                /* Set the new configuration for the mode. */
                /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
                REG_WRITE_LOCK32(MC_ME_BASEADDR, MC_ME_TEST_MC_ADDR32, (uint32)Mcu_pModeConfigPtr->Mcu_u32ModeParams);
...
#if ( MCU_CONFIGURE_CADDRN == STD_ON )
        /* clear the values so that a new mode shitch will not re-apply them */
        /* use the macros to ensure proper values */
        Mcu_MC_ME_DeConfigureCaddrnReg( Mcu_pModeConfigPtr );
#endif /* ( MCU_CONFIGURE_CADDRN == STD_ON ) */
    }
}
...
*
* @param[in]        Mcu_PeriphId   Peripheral ID based ME_PSx registers.
*
...
*
*/
FUNC( Std_ReturnType, MCU_CODE) Mcu_MC_ME_GetPeripheralState(VAR( Mcu_PeripheralId, AUTOMATIC) Mcu_PeriphId)
{
    ...
    /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
    u32RegVal = REG_READ32(MC_ME_PS0_ADDR32 + (((uint32)Mcu_PeriphId >> (uint32)0x05U) * (uint32)MC_ME_PS_OFFSET_U32));

    if ((uint32)0x0U != (uint32)((uint32)u32RegVal & ((uint32)0x01U << ((uint32)Mcu_PeriphId & (uint32)0x1FU ))))
    {
...
STATIC FUNC( void, MCU_CODE) Mcu_MC_ME_ConfigureCaddrnReg(P2CONST( Mcu_MC_ME_ModeConfigType, AUTOMATIC, MCU_APPL_DATA) Mcu_pModeConfigPtr)
{
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore0ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR0_ADDR32, Mcu_pModeConfigPtr->u32McMeCore0ResetControl );
    }
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore1ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR1_ADDR32, Mcu_pModeConfigPtr->u32McMeCore1ResetControl );
    }
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore2ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR2_ADDR32, Mcu_pModeConfigPtr->u32McMeCore2ResetControl );
    }
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore3ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR3_ADDR32, Mcu_pModeConfigPtr->u32McMeCore3ResetControl );
    }
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore4ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR4_ADDR32, Mcu_pModeConfigPtr->u32McMeCore4ResetControl );
    }
}
...
STATIC FUNC( void, MCU_CODE) Mcu_MC_ME_DeConfigureCaddrnReg(P2CONST( Mcu_MC_ME_ModeConfigType, AUTOMATIC, MCU_APPL_DATA) Mcu_pModeConfigPtr)
{
    ...
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR0_ADDR32, MC_ME_CADDR_RESET_DISABLE_U32 );
    }
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore1ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR1_ADDR32, MC_ME_CADDR_RESET_DISABLE_U32 );
    }
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore2ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR2_ADDR32, MC_ME_CADDR_RESET_DISABLE_U32 );
    }
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore3ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR3_ADDR32, MC_ME_CADDR_RESET_DISABLE_U32 );
    }
    if ( MC_ME_CADDR_UNUSED_MASK32 != Mcu_pModeConfigPtr->u32McMeCore4ResetControl )
    {
        /** @violates @ref Mcu_MC_ME_c_REF_4 Conversion form pointer to integer*/
        REG_WRITE32( MC_ME_CADDR4_ADDR32, MC_ME_CADDR_RESET_DISABLE_U32 );
    }
}
#endif /* MCU_CONFIGURE_CADDRN == STD_ON */
