...
/** @violates @ref Mcu_FLASH_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_FLASH_AR_RELEASE_MINOR_VERSION_C        0
/** @violates @ref Mcu_FLASH_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_FLASH_AR_RELEASE_REVISION_VERSION_C     3
...
FUNC(void, MCU_RAM_CODE) Mcu_FLASH_Init_Ram (P2CONST( Mcu_FLASH_ConfigType, AUTOMATIC, MCU_APPL_DATA) FLASH_pConfigPtr);

#if (MCU_INIT_CLOCK == STD_ON)
/* Set the Flash Wait States. */
FUNC(void, MCU_RAM_CODE) Mcu_FLASH_SetWS_Ram (P2CONST(Mcu_FLASH_ClockConfigType, AUTOMATIC, MCU_APPL_DATA) FLASH_pClockConfigPtr);
...
P2FUNC(void, const, Mcu_FLASH_Init) (P2CONST(Mcu_FLASH_ConfigType, AUTOMATIC, MCU_APPL_DATA) FLASH_pConfigPtr) = &Mcu_FLASH_Init_Ram;

#if (MCU_INIT_CLOCK == STD_ON)
/* Pointer to function that configure the wait states. */
P2FUNC(void, const, Mcu_FLASH_SetWS) (P2CONST(Mcu_FLASH_ClockConfigType, AUTOMATIC, MCU_APPL_DATA) FLASH_pClockConfigPtr) = &Mcu_FLASH_SetWS_Ram;
#endif /* (MCU_INIT_CLOCK == STD_ON) */
...
*
*/
/** @violates @ref Mcu_FLASH_c_REF_5 Global declaration of function */
FUNC(void, MCU_RAM_CODE) Mcu_FLASH_Init_Ram(P2CONST( Mcu_FLASH_ConfigType, AUTOMATIC, MCU_APPL_DATA) FLASH_pConfigPtr)
{
