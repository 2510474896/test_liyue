...
*
* @section Mcu_MC_PCU_Types_h_REF_3
...
==================================================================================================*/
/** @violates @ref Mcu_MC_PCU_Types_h_REF_1 MISRA 2004 Required Rule 19.15, Repeated include files.*/
#include "Mcu_Cfg.h"
...
#define MCU_MC_PCU_TYPES_AR_RELEASE_MINOR_VERSION         0
#define MCU_MC_PCU_TYPES_AR_RELEASE_REVISION_VERSION      3
...
#if (MCU_MC_PCU_TYPES_VENDOR_ID != MCU_CFG_VENDOR_ID)
    #error "Mcu_MC_PCU_Types.h and Mcu_Cfg.h have different vendor ids"
#endif
/* Check if source file and Mcu_Cfg header file are of the same Autosar version */
#if ((MCU_MC_PCU_TYPES_AR_RELEASE_MAJOR_VERSION != MCU_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_MC_PCU_TYPES_AR_RELEASE_MINOR_VERSION != MCU_CFG_AR_RELEASE_MINOR_VERSION) || \
     (MCU_MC_PCU_TYPES_AR_RELEASE_REVISION_VERSION != MCU_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Mcu_MC_PCU_Types.h and Mcu_Cfg.h are different"
#endif
/* Check if source file and Mcu_Cfg header file are of the same Software version */
#if ((MCU_MC_PCU_TYPES_SW_MAJOR_VERSION != MCU_CFG_SW_MAJOR_VERSION) || \
     (MCU_MC_PCU_TYPES_SW_MINOR_VERSION != MCU_CFG_SW_MINOR_VERSION) || \
     (MCU_MC_PCU_TYPES_SW_PATCH_VERSION != MCU_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_MC_PCU_Types.h and Mcu_Cfg.h are different"
#endif
...
/********** PMU Registers Configuration **********/
    ...
    /***              PMC_PMCCR                       ***/
    /****************************************************/
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.*/
...
/** @violates @ref Mcu_MC_PCU_Types_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.*/
    ...
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    ...
    /************************************/
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.*/
    #define PMC_VD_INTR_ENA_CONFIG_U32(value)           ( ((value) & PMC_VD_INTR_ENA_RWBITS_USR_MASK32 ) | PMC_VD_INTR_ENA_RESBITS_MASK32 )
    /* This bit determines whether an interrupt is seen by the system when the voltage detect event occurs. */
    #define PMC_VD_INTR_ENA_PMC_INT_EN_U32              (PMC_VD_INTR_ENA_PMC_INT_EN_MASK32)
    #define PMC_VD_INTR_ENA_PMC_INT_DIS_U32             ((uint32)0x00000000U)
    /* This bit determines whether an interrupt is seen by the system when the voltage detect event occurs. */
    #define PMC_VD_INTR_ENA_IO_INT_EN_U32               (PMC_VD_INTR_ENA_IO_INT_EN_MASK32)
    #define PMC_VD_INTR_ENA_IO_INT_DIS_U32              ((uint32)0x00000000U)
    /* PLL Interrupt Enable */
    #define PMC_VD_INTR_ENA_PLL_INT_EN_U32              (PMC_VD_INTR_ENA_PLL_INT_EN_MASK32)
    #define PMC_VD_INTR_ENA_PLL_INT_DIS_U32             ((uint32)0x00000000U)
    /* FLASH Interrupt Enable */
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_FLASH_INT_EN_U32            (PMC_VD_INTR_ENA_FLASH_INT_EN_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_FLASH_INT_DIS_U32           ((uint32)0x00000000U)
    /* HVD ADC Interrupt Enable */
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_HVD_ADC_INT_EN_U32          (PMC_VD_INTR_ENA_HVD_ADC_INT_EN_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_HVD_ADC_INT_DIS_U32         ((uint32)0x00000000U)
    /* LVD ADc Interrupt Enable */
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_LVD_ADC_INT_EN_U32          (PMC_VD_INTR_ENA_LVD_ADC_INT_EN_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_LVD_ADC_INT_DIS_U32         ((uint32)0x00000000U)
    /* HVD Core Interrupt Enable */
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_HVD_CORE_INT_EN_U32         (PMC_VD_INTR_ENA_HVD_CORE_INT_EN_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_HVD_CORE_INT_DIS_U32        ((uint32)0x00000000U)
    /* LVD Core Interrupt Enable */
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_LVD_CORE_INT_EN_U32         (PMC_VD_INTR_ENA_LVD_CORE_INT_EN_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_VD_INTR_ENA_LVD_CORE_INT_DIS_U32        ((uint32)0x00000000U)
    ...
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.*/
    #define PMC_REE_0_CONFIG_U32(value)                 ( ((value) & PMC_REE_0_RWBITS_MASK32 ) | PMC_REE_0_RESBITS_MASK32 )
    /* PMC Reset Enable/Disable Control */
    #define PMC_REE_0_PMS_RST_EN_U32                    (PMC_REE_0_PMS_RST_EN_MASK32)
    #define PMC_REE_0_PMS_RST_DIS_U32                   ((uint32)0x00000000U)
    /* IO Reset Enable/Disable Control */
    #define PMC_REE_0_IO_RST_EN_U32                     (PMC_REE_0_IO_RST_EN_MASK32)
    #define PMC_REE_0_IO_RST_DIS_U32                    ((uint32)0x00000000U)
    /* PLL Reset Enable/Disable Control */
    #define PMC_REE_0_PLL_RST_EN_U32                    (PMC_REE_0_PLL_RST_EN_MASK32)
    #define PMC_REE_0_PLL_RST_DIS_U32                   ((uint32)0x00000000U)
    /* Flash Reset Enable/Disable Control */
    #define PMC_REE_0_FLASH_RST_EN_U32                  (PMC_REE_0_FLASH_RST_EN_MASK32)
    #define PMC_REE_0_FLASH_RST_DIS_U32                 ((uint32)0x00000000U)
    /* HVD ADC Reset Enable/Disable Control */
    #define PMC_REE_0_HVD_ADC_RST_EN_U32                (PMC_REE_0_HVD_ADC_RST_EN_MASK32)
    #define PMC_REE_0_HVD_ADC_RST_DIS_U32               ((uint32)0x00000000U)
    /* LVD ADC Reset Enable/Disable Control */
    #define PMC_REE_0_LVD_ADC_RST_EN_U32                (PMC_REE_0_LVD_ADC_RST_EN_MASK32)
    #define PMC_REE_0_LVD_ADC_RST_DIS_U32               ((uint32)0x00000000U)
    /* HVD Core Reset Enable/Disable Control */
    #define PMC_REE_0_HVD_CORE_RST_EN_U32               (PMC_REE_0_HVD_CORE_RST_EN_MASK32)
    #define PMC_REE_0_HVD_CORE_RST_DIS_U32              ((uint32)0x00000000U)
    /* LVD Core Reset Enable/Disable Control */
    #define PMC_REE_0_LVD_CORE_RST_EN_U32               (PMC_REE_0_LVD_CORE_RST_EN_MASK32)
    #define PMC_REE_0_LVD_CORE_RST_DIS_U32              ((uint32)0x00000000U)
    ...
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_PMC_RST_FUNCTIONAL_U32            (PMC_RES_0_PMC_RST_SEL_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_PMC_RST_DESTRUCTIVE_U32           ((uint32)0x00000000U)

    #define PMC_RES_0_IO_RST_FUNCTIONAL_U32             (PMC_RES_0_IO_RST_SEL_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_IO_RST_DESTRUCTIVE_U32            ((uint32)0x00000000U)

    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_PLL_RST_FUNCTIONAL_U32            (PMC_RES_0_PLL_RST_SEL_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_PLL_RST_DESTRUCTIVE_U32           ((uint32)0x00000000U)

    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_FLASH_RST_FUNCTIONAL_U32          (PMC_RES_0_FLASH_RST_SEL_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_FLASH_RST_DESTRUCTIVE_U32         ((uint32)0x00000000U)

    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_HVD_ADC_RST_FUNCTIONAL_U32        (PMC_RES_0_HVD_ADC_RST_SEL_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_HVD_ADC_RST_DESTRUCTIVE_U32       ((uint32)0x00000000U)

    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_LVD_ADC_RST_FUNCTIONAL_U32        (PMC_RES_0_LVD_ADC_RST_SEL_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_LVD_ADC_RST_DESTRUCTIVE_U32       ((uint32)0x00000000U)

    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_HVD_CORE_RST_FUNCTIONAL_U32       (PMC_RES_0_HVD_CORE_RST_SEL_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_HVD_CORE_RST_DESTRUCTIVE_U32      ((uint32)0x00000000U)

    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_LVD_CORE_RST_FUNCTIONAL_U32       (PMC_RES_0_LVD_CORE_RST_SEL_MASK32)
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
    #define PMC_RES_0_LVD_CORE_RST_DESTRUCTIVE_U32      ((uint32)0x00000000U)
    ...
    /** @violates @ref Mcu_MC_PCU_Types_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.*/
    #define PMC_CTL_TD_TS1_TRIM_ADJ_U32(value)          ((uint32)( (uint32)((value) << (uint32)10U) & PMC_CTL_TD_TS1_TRIM_ADJ_MASK32 ))

        /** @violates @ref Mcu_MC_PCU_Types_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.*/
    #define PMC_CTL_TD_TS0_TRIM_ADJ_U32(value)          ((uint32)( (uint32)((value) << (uint32)2U) & PMC_CTL_TD_TS0_TRIM_ADJ_MASK32 ))
    ...
    #define PMC_REE_LVD_PMC_ENA_U32                     (PMC_REE_LVD_PMC_MASK32)
    #define PMC_REE_LVD_SAR_ADC_ENA_U32                 (PMC_REE_LVD_SAR_ADC_MASK32)
    #define PMC_REE_LVD_IO_ENA_U32                      (PMC_REE_LVD_IO_MASK32)
    #define PMC_REE_HVD_FLASH_ENA_U32                   (PMC_REE_HVD_FLASH_MASK32)
    #define PMC_REE_LVD_FLASH_ENA_U32                   (PMC_REE_LVD_FLASH_MASK32)
    ...
    #define PMC_REE_LVD_PMC_DIS_U32                     ((uint32)0x00000000U)
    #define PMC_REE_LVD_SAR_ADC_DIS_U32                 ((uint32)0x00000000U)
    #define PMC_REE_LVD_IO_DIS_U32                      ((uint32)0x00000000U)
    #define PMC_REE_HVD_FLASH_DIS_U32                   ((uint32)0x00000000U)
    #define PMC_REE_LVD_FLASH_DIS_U32                   ((uint32)0x00000000U)
    ...
    #define PMC_RES_LVD_PMC_ENA_U32                     (PMC_RES_LVD_PMC_MASK32)
    #define PMC_RES_LVD_SAR_ADC_ENA_U32                 (PMC_RES_LVD_SAR_ADC_MASK32)
    #define PMC_RES_LVD_IO_ENA_U32                      (PMC_RES_LVD_IO_MASK32)
    #define PMC_RES_HVD_FLASH_ENA_U32                   (PMC_RES_HVD_FLASH_MASK32)
    #define PMC_RES_LVD_FLASH_ENA_U32                   (PMC_RES_LVD_FLASH_MASK32)
    ...
    #define PMC_RES_LVD_PMC_DIS_U32                     ((uint32)0x00000000U)
    #define PMC_RES_LVD_SAR_ADC_DIS_U32                 ((uint32)0x00000000U)
    #define PMC_RES_LVD_IO_DIS_U32                      ((uint32)0x00000000U)
    #define PMC_RES_HVD_FLASH_DIS_U32                   ((uint32)0x00000000U)
    #define PMC_RES_LVD_FLASH_DIS_U32                   ((uint32)0x00000000U)
...
typedef struct
{
    ...
    VAR( uint32, MCU_VAR) u32VoltageDetectorInterruptControl;
