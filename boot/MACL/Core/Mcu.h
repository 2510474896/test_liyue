...
typedef struct
{
    ...
    CONST( Mcu_RamConfigType, MCU_CONST) (*Mcu_apRamConfig)[];
    /**< @brief Power Modes data configuration. */
    CONST( Mcu_MC_ME_ModeConfigType, MCU_CONST) (*Mcu_apModeConfig)[];
#if (MCU_LPU_SUPPORT == STD_ON)
    /**< @brief Low Power Modes data configuration. */
    CONST( Mcu_LPU_LowPowerModeConfigType, MCU_CONST) (*Mcu_apLowPowerModeConfig)[];
#endif
#if (MCU_INIT_CLOCK == STD_ON)
    /**< @brief Clock data configuration. */
    CONST( Mcu_ClockConfigType, MCU_CONST) (*Mcu_apClockConfig)[];
#endif /* (MCU_INIT_CLOCK == STD_ON) */
