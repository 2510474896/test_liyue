...
*
* @section Mcu_SIUL2_Types_h_REF_1
* Violates MISRA 2004 Required Rule 19.15, : Repeated include files, Precautions shall be taken in
* order to prevent the contents of a header file being included twice This is not a violation since
* all header files are protected against multiple inclusions
*
*
* @section Mcu_SIUL2_Types_h_REF_2
...
==================================================================================================*/
/** @violates @ref Mcu_SIUL2_Types_h_REF_1 MISRA 2004 Required Rule 19.15, Repeated include files.*/
#include "Mcu_Cfg.h"
/** @violates @ref Mcu_SIUL2_Types_h_REF_1 MISRA 2004 Required Rule 19.15, Repeated include files.*/
#include "Soc_Ips.h"
...
#define MCU_SIUL2_TYPES_AR_RELEASE_MINOR_VERSION        0
#define MCU_SIUL2_TYPES_AR_RELEASE_REVISION_VERSION     3
