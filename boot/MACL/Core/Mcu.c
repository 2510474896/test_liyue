...
*/
STATIC P2CONST( Mcu_ConfigType, MCU_VAR, MCU_APPL_CONST) Mcu_pConfigPtr = NULL_PTR;
...
#if ( MCU_PARAM_CHECK == STD_ON )
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckGetMidrStructure(P2CONST( Mcu_MidrReturnType, AUTOMATIC, MCU_APPL_DATA) pMidr);
#endif /* ( MCU_PARAM_CHECK == STD_ON ) */
...
*/
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckInit(P2CONST( Mcu_ConfigType, MCU_VAR, MCU_APPL_CONST) pConfigPtr)
{
    /* local vars */
...
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError ( (uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_INIT_ID, MCU_E_PARAM_CONFIG);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
#else
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckInitRamSection(VAR( Mcu_RamSectionType, AUTOMATIC) RamSection)
{
    ...
    if ( RamSection >= (Mcu_pConfigPtr->Mcu_NoRamConfigs))
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_INITRAMSECTION_ID, MCU_E_PARAM_RAMSECTION);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
    else
    {
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckInitClock( VAR( Mcu_ClockType, AUTOMATIC) ClockSetting )
{
    ...
    if ( ClockSetting >= (Mcu_pConfigPtr->Mcu_NoClkConfigs) )
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_INITCLOCK_ID, MCU_E_PARAM_CLOCK);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckSetMode(VAR( Mcu_ModeType, AUTOMATIC) McuMode)
{
    ...
    if (McuMode >= (Mcu_pConfigPtr->Mcu_NoModeConfigs))
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError ((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_SETMODE_ID, MCU_E_PARAM_MODE);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckGetMidrStructure(P2CONST( Mcu_MidrReturnType, AUTOMATIC, MCU_APPL_DATA) pMidr)
{
    ...
    if ( NULL_PTR == pMidr )
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_GETMIDRSTRUCTURE_ID, MCU_E_PARAM_POINTER);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckDistributePllClock( VAR( void, AUTOMATIC))
{
   VAR( Std_ReturnType, AUTOMATIC) CheckStatus = (Std_ReturnType)E_OK;
    ...
    if ( MCU_PLL_LOCKED != (Mcu_PllStatusType)Mcu_IPW_GetPllStatus() )
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_DISTRIBUTEPLLCLOCK_ID, MCU_E_PLL_NOT_LOCKED);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckPerformReset( VAR( void, AUTOMATIC))
{
    ...
    if ((Std_ReturnType)E_NOT_OK == Mcu_IPW_GetFircStatus())
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_PERFORMRESET_ID, MCU_E_PERFORM_RESET);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckConfigureGpren(VAR (uint8, AUTOMATIC) u8Module)
{
    ...
    if ((Std_ReturnType)E_NOT_OK == Mcu_IPW_CheckEmiosStatus(u8Module))
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_EMIOSCONFIGUREGPREN_ID, MCU_E_EMIOS_DEACTIVATED);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckDisableCMU(VAR (uint8, AUTOMATIC) u8IndexCmu)
{
    ...
    if (MCU_CMU_UNITS <= u8IndexCmu)
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
#if (MCU_DEV_ERROR_DETECT == STD_ON)
        Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_DISABLECMU_ID, MCU_E_CMU_INDEX_OUT_OF_RANGE);
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    }
...
STATIC FUNC(Std_ReturnType, MCU_CODE) Mcu_HLDChecksEntry(VAR( uint8, AUTOMATIC) u8McuServiceID)
{
    ...
    if ( MCU_INIT_ID == u8McuServiceID )
    {
        ...
        {
            CheckStatus = (Std_ReturnType)E_NOT_OK;
            Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, (uint8)u8McuServiceID, MCU_E_ALLREADY_INITIALIZED);
        }
    }
    else
    {
        ...
        {
            CheckStatus = (Std_ReturnType)E_NOT_OK;
            Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, (uint8)u8McuServiceID, MCU_E_UNINIT);
        }
    }
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
    return (Std_ReturnType) CheckStatus;
...
FUNC(void, MCU_CODE) Mcu_Init( P2CONST( Mcu_ConfigType, AUTOMATIC, MCU_APPL_CONST) pConfigPtr)
{
    ...
    VAR(uint32, AUTOMATIC) u32NoConfigs = 0U;
...
FUNC( Std_ReturnType, MCU_CODE) Mcu_InitRamSection( VAR( Mcu_RamSectionType, AUTOMATIC) RamSection)
{
    ...
    VAR(uint32, AUTOMATIC) u32RamContor = (uint32)0U;
    /* Pointer to RAM configuration: base addr, size, default value. */
    P2CONST( Mcu_RamConfigType, AUTOMATIC, MCU_APPL_DATA) pRamConfigPtr;
#endif
...
/* if no ramConfig is defined, the function will do nothing */
        ...
        if((Std_ReturnType)E_OK == (Std_ReturnType)Mcu_CheckInitRamSection(RamSection))
        {
            ...
            for(u32RamContor = (uint32)0UL; u32RamContor < ((uint32)(pRamConfigPtr->Mcu_u32RamSize)); u32RamContor++)
            {
                /**
                * @violates @ref Mcu_c_REF_3 MISRA 2004 Required Rule 17.4, Array indexing shall
                * be the only allowed form of pointer
                */
                (pRamConfigPtr->Mcu_pu8RamBaseAddr)[u32RamContor] = pRamConfigPtr->Mcu_u8RamDefaultValue;
            }
            ...
            /**
            * @violates @ref Mcu_c_REF_3 MISRA 2004 Required Rule 17.4, Array indexing shall be
            * the only allowed form of pointer
            */
            for(u32RamContor = (uint32)0UL; u32RamContor < ((uint32)(pRamConfigPtr->Mcu_u32RamSize)); u32RamContor++)
            {
                /**
                ...
                * be the only allowed form of pointer
                */
                if ((pRamConfigPtr->Mcu_pu8RamBaseAddr)[u32RamContor] != pRamConfigPtr->Mcu_u8RamDefaultValue)
                {
...
* function
*/
FUNC( void, MCU_CODE) Mcu_DistributePllClock(VAR( void, AUTOMATIC))
{
#if ( MCU_VALIDATE_GLOBAL_CALL == STD_ON )
...
FUNC( void, MCU_CODE) Mcu_GetVersionInfo(P2VAR( Std_VersionInfoType, AUTOMATIC, MCU_APPL_DATA) pVersionInfo)
{
    ...
    {
        Det_ReportError((uint16)MCU_MODULE_ID, MCU_INSTANCE_ID, MCU_GETVERSIONINFO_ID, MCU_E_PARAM_POINTER);
    }
    else
    {
#endif /* (MCU_DEV_ERROR_DETECT == STD_ON) */
...
* @violates @ref Mcu_c_REF_6 Violates MISRA 2004 Required Rule 8.10, global declaration of function
*/
FUNC( Std_ReturnType, MCU_CODE) Mcu_GetPeripheralState(VAR( Mcu_PeripheralId, AUTOMATIC) McuPeriphId)
{
    /* Result of the operation. */
 ...
 *
 * @api
 * @implements Mcu_Disable_CMU_Activity
 */
/**
* @violates @ref Mcu_c_REF_6 Violates MISRA 2004 Required Rule 8.10, global declaration of function
*/
FUNC(void, MCU_CODE ) Mcu_Disable_CMU(VAR (uint8, AUTOMATIC) u8IndexCmu)
{
#if ( MCU_VALIDATE_GLOBAL_CALL == STD_ON )
    if((Std_ReturnType)E_OK == (Std_ReturnType)Mcu_HLDChecksEntry(MCU_DISABLECMU_ID))
    {
        ...
        {
#endif /* (MCU_PARAM_CHECK == STD_ON) */
            Mcu_IPW_Disable_CMU(u8IndexCmu);
#if (MCU_PARAM_CHECK == STD_ON)
        }
#endif /* (MCU_PARAM_CHECK == STD_ON) */
#if ( MCU_VALIDATE_GLOBAL_CALL == STD_ON )
