...
#define MCU_SSCM_TYPES_AR_RELEASE_MINOR_VERSION       0
#define MCU_SSCM_TYPES_AR_RELEASE_REVISION_VERSION    3
...
/** @violates @ref Mcu_SSCM_Types_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.*/
