...
*          The functions/variables are part of DIO API.
* @section Dio_C_REF_6
...
*          within a single function. This violation can not be avoided because it is an AUTOSAR requirement
* @section [global]
...
/** @violates @ref Dio_C_REF_1 The compiler/linker shall be checked to ensure that 31
...
/** @violates @ref Dio_C_REF_7 Objects shall be defined at block scope if they are only accessed
...
/** @violates @ref Dio_C_REF_2 Precautions shall be taken in order to prevent the contents of
 ...
 *
 * */
 /** @violates @ref Dio_C_REF_5 All declarations and definitions of objects or
*   functions at file scope shall have internal linkage unless external linkage is required. */
LOCAL_INLINE FUNC(Std_ReturnType, DIO_CODE) Dio_ValidateChannelLevel
(
    VAR(Dio_LevelType, AUTOMATIC) Level
)
{
    ...
    {
        Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, DIO_WRITECHANNEL_ID, DIO_E_PARAM_LEVEL);
    }
...
)
{
    ...
    {
        Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, u8ServiceId, DIO_E_PARAM_INVALID_CHANNEL_ID);
    }
...
)
{
    ...
    {
        Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, u8ServiceId, DIO_E_PARAM_INVALID_PORT_ID);
    }
...
)
{
    ...
    if ((((uint32)(pChannelGroup)) >= ((uint32)Dio_ConfigPC.pChannelGroupList)) && \
        (((uint32)(pChannelGroup)) < (uint32)(Dio_ConfigPC.pChannelGroupList +     \
                                        Dio_ConfigPC.u8NumChannelGroups)) &&       \
    ...
    {
        Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, u8ServiceId, DIO_E_PARAM_INVALID_GROUP_ID);
    }
...
)
{
    ...
    {
        Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, DIO_GETVERSIONINFO_ID, DIO_E_PARAM_POINTER);
    }
    else
