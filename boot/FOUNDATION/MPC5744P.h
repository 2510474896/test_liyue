 ...
 * REVISION:  0.7.18                                  All Rights Reserved *
 *                                                                        *
 * DESCRIPTION:                                                           *
...
struct CAN_tag {
  ...
  uint8_t FLEXCAN_reserved2[48];
  struct canbuf_t MB[64];       /*00000080*/

  uint8_t FLEXCAN_reserved3[1024];
  union {
    vuint32_t R;
      struct {
...
/*********************************************************************************
 * FOR CLR_B MODE, PLEASE REFERE TO THE REFERENCE MANUAL FOR THE REGISTER FORMAT *
 * OF CTU REGISTER.                                                              *
 *********************************************************************************/
...
/*********************************************************************************
 * FOR CLR_C MODE, PLEASE REFERE TO THE REFERENCE MANUAL FOR THE REGISTER FORMAT *
 * OF CTU REGISTER.                                                              *
 *********************************************************************************/
/*
   union {
